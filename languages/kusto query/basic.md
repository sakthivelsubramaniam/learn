...
command used to modify data or meta data or few can be used to show the tables.
* control command, first charector starts with dot.
...
|range | Generates a table with an arithmetic series of values	range columnName from start to stop step step Format Data	Restructure the data to output in a useful way	||
